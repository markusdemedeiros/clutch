...
Section exec_ub.
  ...
  Proof.
    ...
    set (Φ := (λ x, ∀ (ε'' : nonnegreal), ((⌜(x.1.2 <= ε'' )%R⌝ -∗ (bi_least_fixpoint (exec_ub_pre Z) ((x.1.1, ε''), x.2)))))%I : prodO (prodO boolO NNRO) cfgO → iPropI Σ).
    ...
    iIntros "[(? & H)|[(% & % & % & % & % & % & H) | [ (% & % & % & % & % & % & % & H) | [ H | [H | H]]]]] %ε3 %Hleq' /="; simpl in Hleq'.
